...
Bone* Mesh::copySkeletonUsingNecessityMap(const aiNode* node, Bone* parent, const std::map<std::string, bool>& boneNecessary)
{
	Bone* rootBone = 0;
...
Mesh::Mesh(const aiMesh* assimpMesh, const aiNode* meshNode, aiNode* rootNode, const aiMatrix4x4& transform):
...
Mesh::Mesh(const Mesh& rightHand):
...
Mesh& Mesh::operator=(const Mesh& rightHand)
{
	if(this != &rightHand)
	{
		internalClear();
...
void Mesh::draw(GLuint bonesLocation) const
{
