...
public:
	...
	ShaderAnim (char* vertex_name, char* fragment_name);
	~ShaderAnim ();
...
ShaderAnim::ShaderAnim (char* vertex_name, char* fragment_name)
{
...
unsigned int ShaderAnim::GetUniform (const char* name)
{
...
bool ShaderAnim::SetShaderParameters (ShaderMatrices* model_mat_arr, glm::vec3* skinned_pos, glm::quat* skinned_rot)
{
...
const char* ShaderAnim::ReadShaderFromFile (char* file_name)
{
...
void ShaderAnim::OutputShaderError (unsigned int shader_id)
{
	int buffer_size;
...
void ShaderAnim::OutputLinkerError (unsigned int program_id)
{
	int buffer_size;
...
GLuint ShaderAnim::InitShader (char* file_name, unsigned int type)
{
